            ...
            <div className=' bg-white  rounded-lg w-full p-4 text-sm' >
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className=' grid md:grid-cols-3 sm:grid-cols-2  gap-4 mt-6 mb-5 '>
                        ...
                        <p className=' col-span-full border-b-2 pb-1 font-semibold'>Duration of Company</p>
                    ...
                    <div className=' grid md:grid-cols-3 sm:grid-cols-2  gap-4 mt-6 '>
                        ...
                        <div className=' flex flex-col gap-2'>
                            ...
                            <input 
                             {...register("fullname")}
                            className=' hover:border-gray-400    ease-in-out duration-500 py-2 pl-3 border rounded-md border-gray-200 placeholder:text-sm  text-sm' placeholder=' name'></input>
                        </div>
                        <div className=' flex flex-col gap-2'>
                            <label>Email</label>
                            <input
                             {...register("email")}
                            className=' hover:border-gray-400 ease-in-out duration-500 py-2 pl-3 border rounded-md border-gray-200 placeholder:text-sm  text-sm' placeholder='email'></input>
                        </div>
                        <div className=' flex flex-col gap-2'>
                            <label>Mobile No.</label>
                            <input
                             {...register("MobileNo")}
                            className=' hover:border-gray-400 ease-in-out duration-500 py-2 pl-3 border rounded-md border-gray-200 placeholder:text-sm  text-sm ' type='number' placeholder='Mobile No.'></input>
                        </div>
                        <div className=' flex flex-col gap-2'>
                            <label>Gender</label>
                    ...
                    <div className=' grid md:grid-cols-3 sm:grid-cols-2  gap-4 mt-6 '>
                        ...
                        <div className=' flex flex-col gap-2'>
                            ...
                            className=' hover:border-gray-400    ease-in-out duration-500 py-2 pl-3 border rounded-md border-gray-200 text-sm placeholder:text-sm ' placeholder=' company name'></input>
                        </div>
                        <div className=' flex flex-col gap-2'>
                            <label>Compnay Prefix</label>
                            <input
                             {...register("CompanyPrefix")}
                            className=' hover:border-gray-400    ease-in-out duration-500 py-2 pl-3 border rounded-md border-gray-200 text-sm placeholder:text-sm ' placeholder=' prefix'></input>
                        </div>
                        <div className=' flex flex-col gap-2'>
                            <label>Total Employee Count</label>
                            <input 
                             {...register("NoofEmployee")}
                            className=' hover:border-gray-400    ease-in-out duration-500 py-2 pl-3 border rounded-md border-gray-200 text-sm placeholder:text-sm ' placeholder=' No. of employees'></input>
                        </div>
