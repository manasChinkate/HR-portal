...
const MenuMaster = () => {
  ...
  return (
    <div className="w-full h-full bg-background2 flex flex-col gap-2 dark:bg-primary1 py-2 pr-2 overflow-y-auto ">
      <div className="bg-background1 dark:bg-secondary1  border-[1px] border-background2 dark:border-gray-700 md:p-6 p-4 rounded-xl shadow-sm transition-colors duration-200">
        <div>
          <h1 className=" text-2xl font-bold dark:text-gray-100">Add Menu</h1>
