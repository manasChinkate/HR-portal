...
const SessionOut = () => {
  ...
  return (
    <div className="h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 via-white to-blue-100 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900 relative overflow-hidden">
      ...
      <div
        className="absolute bottom-1/3 right-1/6 w-80 h-80 bg-gradient-to-r from-cyan-400/15 to-blue-400/15 rounded-full blur-3xl animate-pulse"
        style={{ animationDelay: "2s" }}
      />

      {/* Main content container */}
      <div
        className={`relative z-10 flex flex-col items-center max-w-2xl mx-auto px-6 transition-all duration-1000 ${
          isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
        }`}
      >
        {/* Header section with enhanced styling */}
        <div
          className={`flex flex-col gap-6 items-center text-center mb-8 transition-all duration-700 delay-200 ${
        ...
        >
          ...
          <div className="relative">
            ...
            />
            <div
              className="absolute -bottom-2 -left-2 w-6 h-6 bg-pink-400 rounded-full animate-bounce"
        ...
        >
          <p className="text-sm text-gray-500 dark:text-gray-400">
            For your security, sessions automatically expire after a period of
            inactivity.
          </p>
        </div>
      </div>
